            ...
            <div className="border-t-2 w-[95%] mx-auto mb-11">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    <ProjectBox
                        ...
                        description="Where the Heel was a fun game inspired by GeoGuessr. Each round, you are random
                        images from around campus, and your goal is to pinpoint where it was taken the best you can.
                        Built for the HackNC competition at UNC in 2024 by Vikram Krishnakumar, Jason Armbruster,
                        Colin Volpe, and Owen Ingram."
                    ...
                    <ProjectBox
                        ...
                        description="ChamaQuest was a project built for the Hack_NCState hackathon in 2025 by
                        Vikram Krishnakumar, Anna Lynch, Colin Volpe, and May Yamanaka. The prototype aims to be a
                        way to connect Rotating Savings and Credit Associations (ROSCAs) in developing countries with
                        banks in order to provide institutional security, while keeping the social aspect many ROSCAs
                        provide."
                    ...
                    <ProjectBox
                        ...
                        description="The Carolina Razor was a concept newspaper for UNC aimed at providing left-wing
                        opinions in a digestible format. The website was created by Vikram Krishnakumar and
                        Alex Kreidler."
