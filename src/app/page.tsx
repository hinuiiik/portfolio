...
export default function Home() {
    return (
        <div className="text-white relative w-full">
            <div id="topbox" className="relative overflow-hidden">
                <LinkParticles />
             ...
             w-full max-w-7xl mx-auto h-screen px-4 sm:px-6 lg:px-8"
                    style={{ transform: "translateY(-3em)" }} // Adjust this value
                >
            ...
            {/* Slim White Line */}
            <div className="mx-auto w-4/5 border-t border-white"></div> {/* This creates the slim white line */}
